find_path(Protobuf_INCLUDE_DIR NAMES google/protobuf/service.h HINTS ${Protobuf_ROOT}/include $ENV{Protobuf_ROOT}/include)

if (USE_DYNAMIC_LIBRARY)
    find_library(Protobuf_LIBRARY NAMES libprotobuf.so HINTS ${Protobuf_ROOT}/lib $ENV{Protobuf_ROOT}/lib)
else (USE_DYNAMIC_LIBRARY)
    find_library(Protobuf_LIBRARY NAMES libprotobuf.a HINTS ${Protobuf_ROOT}/lib $ENV{Protobuf_ROOT}/lib)
endif (USE_DYNAMIC_LIBRARY)

find_program(Protobuf_PROTOC_EXECUTABLE NAMES protoc HINTS ${Protobuf_ROOT}/bin $ENV{Protobuf_ROOT}/bin)
...
if (Protobuf_FOUND)
    ...
    message(FATAL_ERROR "
FATAL: can not find protobuf library in <Protobuf_ROOT>/uni/[include/lib] directory,
