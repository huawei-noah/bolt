...
class Tensorflow2CaffeRotation(Tensorflow2Caffe):
    ...
    def generate(self, input=None):
        ...
        x = self.extract_lstm(x, None, "lstm_backbone", steps=steps,
            scope_id=0, scope_name="lstm_backbone")
        x1 = self.extract_lstm(x, None, "lstm_pose_2", steps=steps,
            scope_id=0, scope_name="lstm_pose_2")
        x2 = self.extract_lstm(x, None, "lstm_scene_2", steps=steps,
