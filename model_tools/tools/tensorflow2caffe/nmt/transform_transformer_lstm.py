...
if __name__ == '__main__':
    tensorflow_model_path = "/data/yuxianzhi/models/nmt/tfm-rnn-288/model.ckpt-217809"
    configure_file_path = "/data/yuxianzhi/models/nmt/tfm-rnn-288/train_options.json"
