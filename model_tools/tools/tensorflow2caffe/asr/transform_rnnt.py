...
if __name__ == '__main__':
    tensorflow_model_path = "/data/models/asr/rnnt-170M/checkpoints/rnnt_spm2048_ms/model.ckpt-424000"
    ...
    if mode == "all":
        ...
        data = {}
        input = np.loadtxt('/data/models/asr/rnnt-450M/sound_data_0.txt')
