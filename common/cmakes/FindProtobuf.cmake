...
if (USE_DYNAMIC_LIBRARY)
    if (USE_IOS_CLANG)
        find_library(Protobuf_LIBRARY NAMES libprotobuf.dylib HINTS $ENV{Protobuf_ROOT}/lib ${Protobuf_ROOT}/lib)
    else (USE_IOS_CLANG)
        find_library(Protobuf_LIBRARY NAMES libprotobuf.so HINTS $ENV{Protobuf_ROOT}/lib ${Protobuf_ROOT}/lib)
    endif (USE_IOS_CLANG)
else (USE_DYNAMIC_LIBRARY)
    find_library(Protobuf_LIBRARY NAMES libprotobuf.a HINTS $ENV{Protobuf_ROOT}/lib ${Protobuf_ROOT}/lib)
