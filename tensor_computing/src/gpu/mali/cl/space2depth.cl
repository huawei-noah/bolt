__kernel void space2depth(const int iw_str, const int ih_str,  const int iw_off, const int ih_off,
                          const int oh_str, const int ohw_str, const int ow_off, const int oh_off,
                          const int bx, const int by, __global const uchar* in, __global T* out) {
